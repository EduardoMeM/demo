...
public class ItemVendaController {
    ...
    public ItemVenda buscarItemVendaPorId(@PathVariable Long id_item_venda) {
        return itemVendaService.buscarItemVendaById(id_item_venda);
    }
    @PutMapping("/{id_item_venda}")
    public ItemVenda atualizarItemVenda(@PathVariable Long id_item_venda, @RequestBody ItemVenda itemVendaAtualizado) {
        return itemVendaService.atualizarItemVenda(id_item_venda, itemVendaAtualizado);
    }
    @DeleteMapping("/{id_item_venda}")
        public void deletarItemVenda(@PathVariable Long id_item_venda){
